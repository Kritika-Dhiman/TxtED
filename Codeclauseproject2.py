...
def find():
    ...
    fentryField=Entry(labelFrame)
    fentryField.grid(row=0, column=1, padx=5, pady=5)
    
    replaceLabel=Label(labelFrame, text='Replace')
    replaceLabel.grid(row=1, column=0, padx=5, pady=5)
    rentryField=Entry(labelFrame)
    rentryField.grid(row=1, column=1, padx=5, pady=5)
...
selectImage=PhotoImage(file='selectall.png')
undoImage=PhotoImage(file='undo.png')
datetimeImage=PhotoImage(file='date_time.png')
...
themesmenu.add_radiobutton(label='Light Default', image=lightImage,variable=theme_choice, compound=LEFT, command=lambda :change_theme('white','black'))
themesmenu.add_radiobutton(label='Dark', image=darkImage,variable=theme_choice, compound=LEFT, command=lambda :change_theme('gray20','white'))
